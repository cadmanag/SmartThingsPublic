 ...
 */
metadata {
    definition (name: "SmartWeather Station Tile - w/ Dew Point & EcoTemp", namespace: "smartthings", author: "SmartThings") {
    ...
    tiles(scale: 2) {
        ...
        valueTile("myFeelsLike", "device.myFeelsLike", decoration: "flat", height: 2, width: 2) {
        ...
        main(["temperature", "weatherIcon", "myFeelsLike"])
        details(["temperature", "myFeelsLike", "weatherIcon", "feelsLike", "humidity", "dewPoint", "wind",
...
def pollUsingZipCode(String zipCode) {
    ...
    if (obs) {
        ...
        send(name: "temperature", value: theTemp, unit: tempUnits)
