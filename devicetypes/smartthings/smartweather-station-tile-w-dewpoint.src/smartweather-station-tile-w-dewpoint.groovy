 ...
 */
metadata {
	definition (name: "SmartWeather Station Tile w/ DewPoint", namespace: "smartthings", author: "SmartThings") {
	...
	tiles {
        ...
        valueTile("myFeelsLike", "device.myFeelsLike") {
		...
		details(["temperature", "feelsLike", "weatherIcon","humidity","dewPoint","wind","weather", "refresh","percentPrecip","alert","rise","set","light","city","statusText", "myFeelsLike"])}
}
...
def poll() {
	...
	if (obs) {
		...
		if(getTemperatureScale() == "C") {
            ...
            send(name: "myFeelsLike", value: Math.round(obs.temp_c + myHumidFeelAdd - myWindFeelDrop), unit: "F")
		} else {
            ...
            send(name: "myFeelsLike", value: Math.round(obs.temp_f + myHumidFeelAdd - myWindFeelDrop), unit: "F")
		}
