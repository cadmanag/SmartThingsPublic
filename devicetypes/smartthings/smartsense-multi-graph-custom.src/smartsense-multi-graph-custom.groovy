metadata {
	...
	definition (name: "SmartSense Multi + Graph - Custom", namespace: "smartthings", author: "SmartThings") {
	...
	tiles {
		...
		details(["contact", "acceleration", "temperature", "3axis", "battery", "refresh", "lqi", "temperatureChart"])
	}
}
