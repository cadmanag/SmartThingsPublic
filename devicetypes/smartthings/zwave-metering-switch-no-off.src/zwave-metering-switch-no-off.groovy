 ...
 */
metadata {
	definition (name: "Z-Wave Metering Switch - No Off", namespace: "smartthings", author: "SmartThings") {
	...
	tiles {
        ...
        valueTile("statusText", "statusText", inactiveLabel: false, width: 2, height: 1, decoration: "flat") {
			state "statusText", label:'${currentValue}', backgroundColor:"#ffffff"
		}   

		main(["switch","power","energy"])
		details(["switch","power","energy","refresh","statusText","reset"])
	}
}
...
def parse(String description) {
    ...
    log.debug "Parsed desc: $description CMD: $cmd"
...
def zwaveEvent(physicalgraph.zwave.commands.basicv1.BasicReport cmd)
{
	...
	if (evt.isStateChange) {
		...
		//evt
        //I always want power usage updates...
        [evt, response(["delay 3000", zwave.meterV2.meterGet(scale: 2).format()])]
	}
}
